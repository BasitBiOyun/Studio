...
const file = path.join(__dirname, 'src', 'constants', 'countries.ts');
...
const countries = [
  ...
  { name: 'Comoros', code: 'km' }, { name: 'Costa Rica', code: 'cr' }, { name: 'Croatia', code: 'hr' },
  ...
  { name: 'Guatemala', code: 'gt' }, { name: 'Guinea', code: 'gn' }, { name: 'Guyana', code: 'gy' },
  ...
  { name: 'Kazakhstan', code: 'kz' }, { name: 'Kenya', code: 'ke' }, { name: 'Kosovo', code: 'xk' },
  { name: 'Kuwait', code: 'kw' }, { name: 'Kyrgyzstan', code: 'kg' }, { name: 'Laos', code: 'la' },
  { name: 'Latvia', code: 'lv' }, { name: 'Lebanon', code: 'lb' }, { name: 'Liberia', code: 'lr' },
  { name: 'Libya', code: 'ly' }, { name: 'Lithuania', code: 'lt' }, { name: 'Luxembourg', code: 'lu' },
  ...
  { name: 'Thailand', code: 'th' }, { name: 'Togo', code: 'tg' }, { name: 'Tunisia', code: 'tn' },
...
let code = `export const COUNTRIES = [\n`;
for (const c of countries) {
  code += `  { name: '${c.name}', flag: '${c.code}', code: '${c.code}' },\n`;
}
code += `];\n`;
