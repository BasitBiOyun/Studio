          ...
          <div className="p-3 sm:p-4 bg-neutral-900/30 border-b border-neutral-800 flex flex-wrap gap-2 items-center justify-between shrink-0">
            <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 min-h-10 rounded-lg bg-neutral-900 border border-neutral-800 text-xs font-semibold text-neutral-300 hover:bg-neutral-800 hover:text-cyan-300 transition-colors"
              >
                <IconHistory size={15} />
                <span>Versions</span>
              </button>
